    ...
    resources: {
      ...
      en: {
        ...
        translation: {
          ...
          not_invoice: 'You do not have any invoices for that category',
          home: 'Home',
          profile: 'Profile',
          invoices: 'Invoices',
          amount: 'Amount',
          ...
          amount_to_be_paid: 'Amount that tenants need to pay to you: ',
          ...
          email_already_sent: 'You already sent email to that tenant in the last 24 hours',
        },
      },
      // Arabic
      pl: {
        translation: {
          ...
          not_invoice: 'Nie masz jeszcze żadnej faktury w tej kategorii',
          home: 'Strona główna',
          profile: 'Profil',
          invoices: 'Faktury',
          ...
          amount_to_be_paid: 'Kwota, którą lokatorzy muszą zapłacić Tobie: ',
